...
timer.Create("epoe_autoplace", 1.003, 0, function()
	...
	epoe.GUI:SetSize(ScrW() * epoe_autoplace_scale_x:GetFloat(), ScrH() * epoe_autoplace_scale_y:GetFloat())
	...
	local offset_x, offset_y = ScrW() - width - margin * 2, ScrH() - height - margin * 2
